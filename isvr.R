...
#library(qmtsvr)
######qmtsvr package functions (rewritten QMTSVR.fit and QMTSVR.GA)
#--------------------------------------------------------------------#
...
#--------------------- End of subroutine ----------------------------------------------------#
#--------------------------------------------------------------------------------------------#
#isvr.fit: This function fits a iSVR with user pre-defined hyper parameters
...
###bibliography
####Alves, A. A. C., Fernandes, A. F. A., Lopes, F. B., Breen, V., Hawken, R., Gianola, D., Rosa, G. J. D. M. (2023). (Quasi) multitask support vector regression with heuristic hyperparameter optimization for whole-genome prediction of complex traits: a case study with carcass traits in broilers. G3: Genes, Genomes, Genetics, 13(8), jkad109.