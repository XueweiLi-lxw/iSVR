...
data2 = data.frame(
  ...
  level  = factor(c(rep(0.01, 5), rep(0.05, 5))),
  value  = c(
    0.037, 0.039, 0.066, 0.572, 0.924,
    0.161, 0.164, 0.208, 0.789, 0.975
  )
)
...
data3 = data.frame(
  ...
  level  = factor(c(rep(0.01, 5), rep(0.05, 5))),
  value  = c(
    0.066, 0.066, 0.143, 0.687, 0.998,
    0.219, 0.221, 0.360, 0.832, 0.998
  )
)
...
case2 = data.frame(
  ...
  level  = factor(c(rep(0.01, 5), rep(0.05, 5))),
  value  = c(
    0.056, 0.057, 0.254, 0.296, 0.658,
    0.164, 0.167, 0.469, 0.534, 0.844
  )
)
...
case3 = data.frame(
  ...
  level  = factor(c(rep(0.01, 5), rep(0.05, 5))),
  value  = c(
    0.026, 0.026, 0.062, 0.069, 0.123,
    0.098, 0.100, 0.185, 0.193, 0.292
  )
)
...
case211 = data.frame(
  ...
  level  = factor(c(rep(0.01, 5), rep(0.05, 5))),
  value  = c(
    0.006, 0.006, 0.061, 0.021, 0.211,
    0.041, 0.041, 0.180, 0.090, 0.427
  )
)
...
case311 = data.frame(
  ...
  level  = factor(c(rep(0.01, 5), rep(0.05, 5))),
  value  = c(
    0.013, 0.013, 0.312, 0.086, 0.439,
    0.069, 0.070, 0.532, 0.247, 0.668
  )
)
