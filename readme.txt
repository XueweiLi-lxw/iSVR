...
The iSVR, VWTOWGE (TOWGE) and CKLRT methods are implemented with parallel computing algorithms, while GESAT and iSKAT adopt the conventional computational framework.
